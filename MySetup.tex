...
\usepackage[english,spanish]{babel} % Agregamos el idioma español
...
\usepackage{xcolor}
\newcommand{\MiUltimaActualizacion}[1]{%
  \noindent \textcolor{ColorOne}{Última actualización:} #1\par
}
%-------------------------------------------------------------------------------------------------------
% Layout
%-------------------------------------------------------------------------------------------------------
...
\definecolor{ColorTwo}{RGB}{0,51,102} 	% Mauve
